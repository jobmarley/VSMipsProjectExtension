...
namespace FPGAProjectExtension
{
	...
	//[ProjectTypeRegistration(FPGAProjectExtensionPackage.ProjectTypeGuid, "FPGA Project", "#2", ProjectExtension, Language, resourcePackageGuid: FPGAProjectExtensionPackage.PackageGuidString, PossibleProjectExtensions = ProjectExtension)]
	...
	//	/// </summary>
	//	internal const string ProjectExtension = "vcxproj";
	...
	//	/// </remarks>
	//	public const string UniqueCapability = "MyCompany.FPGAProject";
